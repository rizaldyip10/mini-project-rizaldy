...
const router = createBrowserRouter([
  ...
  {path: '/category', element: <CatPage />, children: [
    {path: "ekonomi", element: <EkonomiCard />},
    {path: "teknologi", element: <TechCard />},
    {path: "olahraga", element: <SportsCard />},
    {path: "kuliner", element: <KulinerCard />},
    {path: "internasional", element: <InterCard />},
    {path: "fiksi", element: <FiksiCard />},
  ]},
